...
echo form_open("bank/update/$id", $attributes); ?>

<p>
        <label for="bank_name">Bank Name <span class="required">*</span></label>
        <?php echo form_error('bank_name'); ?>
        <br /><input id="bank_name" type="text" class="form-control" name="bank_name" maxlength="255" value="<?php echo set_value('bank_name',$results[0]->account_number); ?>"  />
</p>

<p>
        <label for="branch_name">Branch Name <span class="required">*</span></label>
        <?php echo form_error('branch_name'); ?>
        <br /><input id="branch_name" type="text" class="form-control" name="branch_name"  value="<?php echo set_value('branch_name',$results[0]->account_number); ?>"  />
</p>

<p>
        <label for="account_number">Account Number <span class="required">*</span></label>
        <?php echo form_error('account_number'); ?>
        <br /><input id="account_number" type="text" class="form-control" name="account_number"  value="<?php echo set_value('account_number',$results[0]->account_number); ?>"  />
</p>
